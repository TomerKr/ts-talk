...
export type Action<T extends string = string, P = any> = TypedAction<T> | PayloadAction<T, P>
...
export function createAction<T extends string, P = undefined>(type: T, payload?: P): TypedAction<T> | PayloadAction<T, P> {
